...
class MyWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.load_data()
        self.ui.pushButton.setIcon(QIcon('icons/database.ico'))
        self.ui.pushButton.setIconSize(QtCore.QSize(55, 55))
        self.ui.pushButton_2.setIcon(QIcon('icons/add.ico'))
        self.ui.pushButton_2.setIconSize(QtCore.QSize(55, 55))
        self.ui.pushButton_3.setIcon(QIcon('icons/delete.ico'))
        self.ui.pushButton_3.setIconSize(QtCore.QSize(55,55))
        self.ui.pushButton_5.setIcon(QIcon('icons/find.ico'))
        self.ui.pushButton_5.setIconSize(QtCore.QSize(42,24))
        self.ui.pushButton_4.setIcon(QIcon('icons/refresh.ico'))
        ...
        self.ui.pushButton_4.clicked.connect(lambda: (self.load_data(), QSound.play('sounds/update.wav')))
    ...
    def search_data(self):
        ...
        if not search_text:
            ...
            return
        QSound.play('sounds/yesorno.wav')
